...
import { ICartProduct, IOrderItem } from '@component/interfaces';
...
export const CartList: FC<Props> = ({ editable = false, products }) => {
    ...
    const onCartNewQuantityValue = (product: ICartProduct, newQuantityValue: number) => {
                                    ...
                                    editable
                                        ? (
                                            <ItemCounter
                                                ...
                                                maxValue={5}
                                                updatedQuenatity={(newValue) => onCartNewQuantityValue(product as ICartProduct, newValue)}
                                            />
